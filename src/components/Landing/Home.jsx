...
export default function Home() {
  return (
    <>
      <Header />
      {/* Hero Section */}
      <div className="hero-wrapper hero-1 hero-bg bg-img" style={{height: "100vh"}}>
      ...
      <div className="why-choose-us hero-1 bg-img" id="why-us">
        ...
        <div className="comparison-table">
          <h3 className="text-light">Traditional vs. Decentralized Crowdfunding</h3>
      ...
      <div className="testimonials hero-1 bg-img" id="success-stories">
        <h2 className="section-title text-light">Success Stories & Testimonials</h2>
      ...
      <div className="security hero-1 bg-img" id="security">
        <h2 className="section-title text-light"><img className="img-img" src={security} alt="" />Security & Transparency</h2>
      ...
      <div className="community-impact hero-1 bg-img" id="community">
        <h2 className="section-title text-light"><img className="img-img" src={crowdfunding} alt="" />Community & Social Impact</h2>
        <p className="section-description">
      ...
      <div className="cta-section">
        <h2 className="cta-title text-light"><img className="img-img" src={deal} alt="" /> Ready to Make a Difference?</h2>
        <p className="cta-description">Start Your Fundraiser or Contribute Today!</p>

        <div className="cta-buttons">
          <Link to="/create-campaign" className="cta-btn primary">Join CoopGenix</Link>
      ...
      <div className="fundraising-stats hero-1 bg-img">
        <h2 className="stats-title text-light"><img className="img-img" src={loan} alt="" /> Latest Fundraiser</h2>
        ...
        <div className="featured-fundraisers">
          <h3 className="text-light"><img className="img-img" src={economy} alt="" /> Top Gainer</h3>
      ...
      <div className="get-involved hero-1 bg-img" id="getInvolved">
        ...
        <div className="involved-boxes">
          ...
          <div className="involved-box">
            ...
            <p>We ensure legitimacy with a strict campaign verification process.</p>
            {/* <Link to="/create-campaign" className="cta">Start Fundraising</Link> */}
          </div>
        </div>
      </div>
